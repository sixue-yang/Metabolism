...
if __name__ == '__main__':
    ...
    pathway_dir = os.path.join(os.path.dirname(spe_database),os.path.basename(spe_database).split('.')[0])
    ...
    if os.path.getsize(kegg_result) == 0:
        ...
        for id_ in pathway_ids:
            image_path = pathway_dir + os.sep + id_ + '.png'
            new_path = out_dir + os.sep + id_ + '.png'
